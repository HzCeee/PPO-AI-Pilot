...
def traj_segment_generator(pi, env, horizon, stochastic):
    ...
    while True:
        ...
        ############################
        if t % 500 == 0:
            saver.save(tf.get_default_session(), '/home/projectvenom/Documents/AIPilot/PPO-AI-Pilot/model/Exp1')
            if roll_success_rate and np.mean(roll_success_rate) > max_success_rate:
                max_success_rate = np.mean(roll_success_rate)
                saver.save(tf.get_default_session(), '/home/projectvenom/Documents/AIPilot/PPO-AI-Pilot/model/Exp1_best')
        ############################
